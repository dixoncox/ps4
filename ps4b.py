...
def compPlayHand(hand, wordList, n):
    ...
    while compChooseWord(updatedHand, wordList, n) != None and (calculateHandlen(updatedHand)>0):
        print
        print 'Current Hand: ', 
...
#    print "playGame not yet implemented." # <-- Remove this when you code this function
    ...
    while gameChoice != 'e': #gameChoice != 'n' and gameChoice != 'r' and 
        gameChoice = raw_input('Enter n to deal a new hand, r to replay the last hand, or e to end game: ') #check
        #hand = dealHand(n)
        #if gameChoice == 'r' and hand == {}:
        #        print 'You have not played a hand yet. Please play a new hand first!'                     
        if gameChoice == 'n' or (gameChoice == 'r' and hand != {}): #check
            if gameChoice == 'n':
